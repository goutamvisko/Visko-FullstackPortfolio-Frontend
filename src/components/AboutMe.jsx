          ...
          >
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed">
                I specialize in building modern web apps using Javascript,React,Node,Mongodb,Mysql,Nextjs etc.
                and other cutting-edge technologies. I enjoy
              ...
              <p className="text-gray-300 leading-relaxed">
                As a <span className="text-red-400">Full-Stack Developer</span>{" "}
                and <span className="text-red-400">AI enthusiast</span>, I love
                integrating intelligent features into applications to make them
                smarter and more scalable. I stay curious about{" "}
                <span className="text-red-400">
                  cloud, DevOps, and automation
                </span>{" "}
                while experimenting with ML models. Collaboration, mentorship,
                and building impactful digital solutions drive my passion for
                tech.
              </p>
            </motion.div>
          </motion.div>
